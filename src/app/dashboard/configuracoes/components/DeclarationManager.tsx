        ...
        <section className="space-y-6">
            <Card className="border-t-4 border-t-blue-600">
                <CardHeader>
                    ...
                    <CardDescription>
                        Envie os dados consolidados para o CFA. Prazo final: 20/03/2026.
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    {isPastDeadline ? (
                        <Alert variant="destructive">
                            ...
                            <AlertDescription>
                                O prazo de entrega e retificação encerrou em 20/03/2026. Não é possível realizar novas entregas ou alterações.
                            </AlertDescription>
                        </Alert>
                    ) : (
