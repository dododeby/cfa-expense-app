                        ...
                        <CardContent className="space-y-4">
                            <div>
                                ...
                                <p className="text-sm text-slate-600">
                                    Ressaltamos que o prazo final para o preenchimento e envio das informações é 20 de março de 2026.
                                </p>
                            </div>
                            <div>
                ...
                <TabsContent value="duvidas" className="space-y-4">
                    <Card className="border-amber-200 bg-amber-50">
                        ...
                        <CardContent className="pb-3 text-sm text-amber-700">
                            Ressaltamos que o prazo final para o preenchimento e envio das informações é <strong>20 de março de 2026</strong>.
                        </CardContent>
                    </Card>
